            ...
            <div className="mt-10">
              ...
              <div className="mt-6 sm:max-w-xl">
                ...
                <p className="mt-6 text-xl text-gray-500">
                  Healthcare organisations struggle to detect patient behaviours (falls, pain, distress) in real time excluding visual data due to identifiable information. 
                </p>
                <p className="mt-6 text-xl text-gray-500">
                  The main challenge is that most existing systems count heavily on visual data and manual reporting.
                </p>
              </div>
              {/* <div className="mt-6 sm:max-w-xl">
